...
export const QUESTIONS: Question[] = [
  {
    id: 1,
    question:
      'En referencia a la magnitud radiológica "exposición", podemos afirmar que:',
    options: {
  ...
  },
  {
    id: 2,
    question:
      "En referencia al laberinto de la sala de tratamiento, es cierto que:",
    options: {
  ...
  },
  {
    id: 3,
    question:
      "En la gestión de los residuos radiactivos se definen varios conceptos, entre los que se encuentra:",
    options: {
  ...
  },
  {
    id: 4,
    question:
      "En referencia a la modificación de la sensibilidad celular, indica qué afirmación es INCORRECTA:",
    options: {
  ...
  },
  {
    id: 5,
    question:
      "En referencia a la interacción de los electrones con la materia, es cierto que:",
    options: {
  ...
  },
  {
    id: 8,
    question:
      "¿Cuál es la posición estándar del paciente para la simulación de radioterapia en seminoma?",
    options: {
      a: "Decúbito prono.",
      b: "Decúbito supino.",
      c: "Decúbito lateral.",
  ...
  },
  {
    id: 10,
    question:
      "En referencia a los sistemas de detección de la radiación, la capacidad de dar un valor reproducible, poco variable y con la mínima ambigüedad posible se denomina:",
    options: {
      a: "Eficiencia.",
      b: "Sensibilidad.",
      c: "Exactitud.",
  ...
  },
  {
    id: 14,
    question:
      "Entre las recomendaciones para la TC de planificación de un tratamiento de cáncer de recto, NO se encuentra:",
    options: {
  ...
  },
  {
    id: 15,
    question:
      "Para garantizar el paralelismo y la distancia exacta entre agujas en un implante de mama, se utiliza:",
    options: {
      a: "Un endoscopio.",
  ...
  },
  {
    id: 16,
    question:
      "Según el modelo de las etapas de aceptación de la enfermedad, ¿cómo suele manifestarse la segunda fase del proceso?",
    options: {
  ...
  },
  {
    id: 18,
    question:
      "En el proceso de formación de radiación de frenado, la radiación formada será mayor:",
    options: {
  ...
  },
  {
    id: 19,
    question:
      "Entre las funciones del Técnico o Técnica Especialista en Radioterapia NO se encuentra:",
    options: {
  ...
  },
  {
    id: 20,
    question:
      "En el cáncer de pulmón de célula pequeña (estadio III), ¿cuál es la recomendación terapéutica general?",
    options: {
  ...
  },
  {
    id: 22,
    question:
      "En la simulación del cáncer de vejiga, ¿cómo debe estar el recto en el momento de adquirir imágenes de TC?",
    options: {
      a: "Totalmente lleno.",
      b: "Totalmente vacío.",
  ...
  },
  {
    id: 23,
    question:
      "¿Qué proceso elimina cualquier forma de vida microbiana, incluidas las esporas, ya sea mediante métodos físicos o químicos?",
    options: {
      a: "Esterilización.",
      b: "Desinfección.",
      c: "Antisepsia.",
  ...
  },
  {
    id: 25,
    question:
      "¿Cómo se denomina el efecto mediante el cual el filamento emite electrones al calentarse?",
    options: {
      a: "Efecto ionizador.",
  ...
  },
  {
    id: 27,
    question:
      "Sobre la neumonitis como efecto secundario de un tratamiento externo en tumores de mama, ¿qué afirmación NO es correcta?",
    options: {
  ...
  },
  {
    id: 28,
    question:
      "En la planificación de braquiterapia de mama, ¿cuál es el margen habitual de tejido sano añadido alrededor del lecho tumoral tras una cirugía conservadora para definir el PTV?",
    options: {
      a: "1-2 mm.",
      b: "5-10 mm.",
      c: "15-20 mm.",
  ...
  },
  {
    id: 29,
    question:
      "En referencia a los equipos de terapia de contacto utilizados en teleterapia, es cierto que:",
    options: {
  ...
  },
  {
    id: 30,
    question:
      "¿Cuál de las siguientes magnitudes tiene en cuenta la distinta radiosensibilidad de cada órgano en una irradiación de cuerpo entero?",
    options: {
      a: "Dosis absorbida.",
      b: "Dosis equivalente.",
      c: "Dosis efectiva.",
  ...
  },
  {
    id: 31,
    question:
      "En referencia a las barreras de protección radiológica en la sala de tratamiento, el anillo de refuerzo:",
    options: {
  ...
  },
  {
    id: 32,
    question:
      "En referencia al proceso de ionización de un átomo por interacción de la radiación con un electrón de la corteza, es cierto que:",
    options: {
  ...
  },
  {
    id: 34,
    question:
      "Entre los efectos secundarios en el hígado tras la irradiación de un cáncer de estómago, NO se encuentra:",
    options: {
      a: "Ascitis.",
  ...
  },
  {
    id: 35,
    question:
      "En el esquema de hipofraccionamiento semanal para mama en teleterapia externa, ¿cómo se administra la dosis?",
    options: {
  ...
  },
  {
    id: 36,
    question:
      "¿Cuál es el tratamiento curativo más efectivo para el cáncer de páncreas?",
    options: {
      a: "Quimioterapia.",
      b: "Radioterapia.",
      c: "Cirugía.",
  ...
  },
  {
    id: 37,
    question:
      "Entre los diferentes fenómenos físicos que se aprovechan para detectar y medir la radiación se encuentra:",
    options: {
  ...
  },
  {
    id: 38,
    question:
      "Entre los parámetros utilizados para caracterizar una curva de dosis en profundidad de electrones NO encontramos:",
    options: {
  ...
  },
  {
    id: 39,
    question:
      "En referencia a los equipos de energía media u ortovoltaje utilizados en teleterapia, NO es cierto que:",
    options: {
  ...
  },
  {
    id: 40,
    question:
      "En el cáncer de endometrio, ¿en qué se diferencia el estadio IA del IB?",
    options: {
  ...
  },
  {
    id: 44,
    question:
      "El análisis de perfiles de dosis para haces de fotones y electrones se puede utilizar para:",
    options: {
  ...
  },
  {
    id: 45,
    question:
      "En referencia a la Dosis Biológica Equivalente (DBE), es cierto que:",
    options: {
  ...
  },
  {
    id: 46,
    question:
      "Para la definición del volumen de tratamiento en el cáncer de estómago, ¿qué elemento quirúrgico es de gran utilidad?",
    options: {
  ...
  },
  {
    id: 47,
    question:
      "En un tratamiento con haces de electrones, ¿cuál NO es un inconveniente en la utilización de la lámina dispersora?",
    options: {
  ...
  },
  {
    id: 48,
    question:
      "En la braquiterapia prostática, ¿qué tipo de prueba de verificación se realiza tras insertar las semillas?",
    options: {
      a: "Cistometría.",
      b: "Cistografía.",
      c: "Ecografía vesical.",
