...
export const COMMON_QUESTIONS_101_150: Question[] = [
  {
    id: 401,
    question:
  ...
  },
  {
    id: 405,
    question:
      "Según dispone la Ley Orgánica 3/2018, de 5 de diciembre, de Protección de Datos Personales y garantía de los derechos digitales, podrán tener acceso a los datos personales de las personas fallecidas:",
    options: {
  ...
  },
  {
    id: 407,
    question:
      "Con relación al tratamiento de los datos personales de una persona menor de edad, señale la respuesta correcta:",
    options: {
  ...
  },
  {
    id: 408,
    question:
      "La Ley Orgánica 3/2018, de 5 de diciembre, de Protección de Datos Personales y garantía de los derechos digitales, en su artículo 9 considera categorías especiales de datos aquellos que permitan, respecto a la persona afectada, identificar:",
    options: {
  ...
  },
  {
    id: 411,
    question:
      "Con relación al tratamiento de datos con fines de videovigilancia, señale la respuesta correcta:",
    options: {
  ...
  },
  {
    id: 412,
    question:
      "Respecto a los sistemas de información de denuncias internas que contempla la Ley Orgánica 3/2018, de 5 de diciembre, de Protección de Datos Personales y garantía de los derechos digitales, es correcta la siguiente afirmación:",
    options: {
  ...
  },
  {
    id: 413,
    question:
      "El artículo 1 del Decreto Legislativo 1/2023, de 16 de marzo, por el que se aprueba el texto refundido de la Ley para la Igualdad de Mujeres y Hombres y Vidas Libres de Violencia Machista contra las Mujeres, añade un concepto específico al objeto de la ley que refuerza el fin último de la norma, ¿cuál es?",
    options: {
  ...
  },
  {
    id: 419,
    question:
      "De acuerdo con lo establecido en el artículo 54 del texto refundido de la Ley para la Igualdad de Mujeres y Hombres y Vidas Libres de Violencia Machista contra las Mujeres, aprobado por el Decreto Legislativo 1/2023, de 16 de marzo, ¿cómo se define la 'violencia machista contra las mujeres'?",
    options: {
  ...
  },
  {
    id: 421,
    question:
      "¿Cuántos Objetivos Generales, clasificados como finalistas e instrumentales, se definen en la estructura del Plan de Salud Euskadi 2030?",
    options: {
  ...
  },
  {
    id: 422,
    question:
      "Según el Plan de Salud Euskadi 2030, la VISIÓN que se aspira a lograr como país es:",
    options: {
  ...
  },
  {
    id: 423,
    question:
      "¿Cuál de los siguientes NO es un principio rector en los que se apoya el Plan de Salud Euskadi 2030?",
    options: {
  ...
  },
  {
    id: 424,
    question:
      "El Objetivo General 1 (OG1) del Plan de Salud Euskadi 2030 se enfoca en:",
    options: {
  ...
  },
  {
    id: 425,
    question:
      "El Objetivo General 4 (OG4) del Plan de Salud Euskadi 2030 se define como 'lograr la sostenibilidad y excelencia en los sistemas asistenciales sanitarios y sociosanitarios de Euskadi', ¿en términos de qué tres conceptos clave?",
    options: {
  ...
  },
  {
    id: 426,
    question:
      "¿A qué hace referencia el acrónimo AVAD en el Plan de Salud Euskadi 2030?",
    options: {
  ...
  },
  {
    id: 427,
    question:
      "¿Cuál es uno de los objetivos clave del Plan de Salud Euskadi 2030, reiterado en varias secciones, respecto a la equidad y la gestión de la enfermedad?",
    options: {
  ...
  },
  {
    id: 428,
    question:
      "¿Qué enfoque de investigación prioriza el Plan de Salud Euskadi 2030 para asegurar que los avances científicos lleguen de forma efectiva a la práctica clínica y la salud de la población?",
    options: {
  ...
  },
  {
    id: 429,
    question:
      "Según el modelo de evaluación del Plan de Salud Euskadi 2030, ¿cuáles son los cuatro criterios fundamentales para determinar el éxito de las intervenciones?",
    options: {
  ...
  },
  {
    id: 430,
    question:
      "En la lucha contra las desigualdades, ¿qué tipo de soluciones habitacionales promueve el Plan de Salud Euskadi 2030 para las diferentes etapas de la vida?",
    options: {
  ...
  },
  {
    id: 431,
    question:
      "Según la comparativa de la Memoria Económica del Plan de Salud Euskadi 2030, ¿cuál es el programa presupuestario (fuera del gasto general de Osakidetza) con mayor dotación?",
    options: {
  ...
  },
  {
    id: 432,
    question:
      "El Plan de Salud Euskadi 2030 busca lograr 'comunidades amigables' para las personas mayores. ¿Cuál es la finalidad última de esta estrategia?",
    options: {
  ...
  },
  {
    id: 434,
    question:
      "¿Cómo define el Plan de Salud Euskadi 2030 el concepto de 'Intersectorialidad' en la gestión de la salud?",
    options: {
  ...
  },
  {
    id: 436,
    question:
      "Según el análisis del contexto social del documento de Diagnóstico del Pacto Vasco de Salud de Euskadi, ¿qué factor se identifica como un motor clave para que la ciudadanía del siglo XXI demande un papel más activo en su salud?",
    options: {
  ...
  },
  {
    id: 437,
    question:
      "El documento de Diagnóstico del Pacto Vasco de Salud de Euskadi señala que los flujos migratorios actuales en Euskadi:",
    options: {
  ...
  },
  {
    id: 438,
    question:
      "¿Cuál es uno de los principales desafíos identificados en el documento de Diagnóstico del Pacto Vasco de Salud de Euskadi respecto a la formación y relevo del personal sanitario?",
    options: {
  ...
  },
  {
    id: 439,
    question:
      "Sobre el impacto del cambio global y climático, el documento de Diagnóstico del Pacto Vasco de Salud de Euskadi advierte de la aparición de:",
    options: {
  ...
  },
  {
    id: 440,
    question:
      "El documento de Diagnóstico del Pacto Vasco de Salud de Euskadi propone que los indicadores sanitarios para evaluar el sistema deben:",
    options: {
  ...
  },
  {
    id: 441,
    question:
      "¿Cuál es la finalidad principal de los Valores Fundamentales del Pacto Vasco de Salud, según el Libro de Valores y principios?",
    options: {
  ...
  },
  {
    id: 442,
    question:
      "¿Cuál de los siguientes es un Valor Fundamental explícito del Pacto Vasco de Salud, además de la Universalidad y la Equidad?",
    options: {
  ...
  },
  {
    id: 443,
    question:
      "El principio de Innovación en el Pacto Vasco de Salud se aplica a:",
    options: {
  ...
  },
  {
    id: 444,
    question:
      "En el marco del Pacto Vasco de Salud, dentro de los principios rectores, la 'Orientación al Valor' significa que el sistema debe priorizar:",
    options: {
  ...
  },
  {
    id: 445,
    question:
      "¿En qué grandes ámbitos se estructuran las Líneas Estratégicas del Pacto Vasco de Salud?",
    options: {
  ...
  },
  {
    id: 446,
    question:
      "¿Cuál es el papel de la Atención Primaria y Comunitaria dentro de las Líneas Estratégicas del Pacto Vasco de Salud?",
    options: {
  ...
  },
  {
    id: 447,
    question:
      'En relación con la Línea Estratégica 06 sobre "Cronicidad" del Pacto Vasco de Salud, ¿qué objetivo se persigue primordialmente?',
    options: {
  ...
  },
  {
    id: 448,
    question:
      'La Línea Estratégica 07 sobre "Atención Sociosanitaria" del Pacto Vasco de Salud subraya la necesidad de:',
    options: {
  ...
  {
    id: 449,
    question: "Respecto a la 'Salud Mental' (Línea 11), el Pacto Vasco de Salud pone el foco en:",
    options: {
  ...
  {
    id: 450,
    question: "La Línea Estratégica 18 sobre \"Digitalización en Salud\" del Pacto Vasco de Salud busca la transformación digital para:",
    options: {
